module github.com/JuanGQCadavid/now-project/services/spotsScheduledService
...
require (
	github.com/JuanGQCadavid/now-project/services/authService v0.0.0-20240715090330-bc960bdae3da // indirect
