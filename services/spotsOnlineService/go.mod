module github.com/JuanGQCadavid/now-project/services/spotsOnlineService
...
require (
	...
	github.com/JuanGQCadavid/now-project/services/spotsScheduledService v0.0.0-20230421002411-21e2931cf24e
